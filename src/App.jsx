// Importa os ulos React e useState, bem como os arquivos de estilo CSS.
...
function IMC() {
  ...
  const calcularIMC = () => {
    if (peso > 0 && altura > 0) {
      ...
      setIMC(imcValor); // Define o valor do IMC calculado no estado "imc".       setClassificacao(obterClassificacao(imcValor)); // Calcula a classificação com base no IMC.
    }
  };
